function owlCarouselFacade($_this, _options, _scales, $_prev, $_next, _updateOnResize = true, $_lightgallerySelector = '') {
                ...
                if (!_enabled) {
                    let callbacks = {
                        onInitialized(ev) {
                            ...
                            if ($_lightgallerySelector != '') {
                                $_this.lightGallery({
                                    selector: $_lightgallerySelector,
                                    thumbnail: false
                                })
                            }
                            resolve();
